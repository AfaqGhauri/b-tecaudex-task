...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-10 whitespace-nowrap px-2 text-left align-middle font-medium text-blackColorOne [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn('mt-4 text-sm text-blackColorOne', className)}
      {...props}
    />
  );
}
